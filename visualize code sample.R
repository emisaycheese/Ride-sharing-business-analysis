...
cohort_drivers <- data.frame(cohort=c('19(2016-05-15)', '18', '17', '16', '15', '14', '13(2016-03-28)'),
                     week13=c(0,0,0,0,0,0,126),
                     week14=c(0,0,0,0,0,146,113),
                     week15=c(0,0,0,0,125,131,97),
                     week16=c(0,0,0,118,115,125,94),
                     week17=c(0,0,108,115,101,113,89),
                     week18=c(0,104,99,108,101,115,86),
                     week19=c(94,100,91,102,92,102,83),
                     week20=c(88,90,84,90,94,101,78),
                     week21=c(85,84,85,85,89,99,74),
                     week22=c(75,79,81,89,85,103,78),
                     week23=c(73,76,74,76,84,103,77),
                     week24=c(66,69,64,79,82,99,71),
                     week25=c(67,66,64,76,85,90,67))
#week26=c(1,2,3,3,1,2,1))
